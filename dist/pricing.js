...
const DEFAULT_RATE = { inputPerMTok: 3, outputPerMTok: 15, cacheReadPerMTok: 0.3 };
...
export function estimateCostFromTokens(modelName, inputTokens, outputTokens, cacheReadTokens) {
