...
function getTrendSamplePath(key) {
 ...
 */
export function recordTrendSample(key, value, windowMs) {
...
export function readTrendRatePerMin(key, windowMs) {
    const filePath = getTrendSamplePath(key);
    const cutoff = Date.now() - windowMs;
...
//# sourceMappingURL=trend-samples.js.map