...
export declare function quotaHeatBar(percent: number, width?: number, colors?: Partial<HudColorOverrides>): string;
export declare function quotaBrailleBar(percent: number, width?: number, colors?: Partial<HudColorOverrides>): string;
export declare function effortCurve(level: string | null | undefined): string;
export declare function coloredBar(percent: number, width?: number, colors?: Partial<HudColorOverrides>): string;
export declare function burnHeatColor(velocity: number, colors?: Partial<HudColorOverrides>): string;
export declare function coloredBarWithMarker(percent: number, width: number | undefined, markerPercent: number, burnColor?: string, colors?: Partial<HudColorOverrides>): string;
