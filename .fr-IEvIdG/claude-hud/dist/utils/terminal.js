 ...
 */
function queryControllingTerminal() {
...
export function getWidthCandidates() {
    return {
...
export function getTerminalWidth() {
    ...
    const pool = [c.env, c.controlling, c.stderr].filter((v) => v !== null);
    if (pool.length > 0) {
...
export function getAdaptiveBarWidth(cols) {
